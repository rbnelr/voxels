	...
	public class TerrainMesher : MonoBehaviour {
		...
		public class SeamMeshingJob {
			...
			public struct Mesh {
				...
				public void EmitTriangle (Cells cells, int3 indxA, int3 indxB, int3 indxC, float cellSize) {
					cells.GetActiveCell(indxA, out Cell a);
					cells.GetActiveCell(indxB, out Cell b);
					cells.GetActiveCell(indxC, out Cell c);
